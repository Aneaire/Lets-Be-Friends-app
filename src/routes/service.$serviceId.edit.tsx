...
export const Route = createFileRoute('/service/$serviceId/edit')({
...
function EditService() {
  ...
  const updateService = useConvexMutation(api.services.updateService)
  ...
  if (!currentUser || currentUser._id !== service.userId) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto text-center">
          <p>You can only edit your own services.</p>
        </div>
      </div>
    )
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.navigate({ to: '/service/$serviceId', params: { serviceId: service._id as string } })
      }, 1500)
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <button
            onClick={() => router.navigate({ to: '/service/$serviceId', params: { serviceId: service._id as string } })}
        ...
        <form onSubmit={handleSubmit} className="bg-card border rounded-lg p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <label htmlFor="isActive" className="text-sm">
              Make this service active and visible to others
            </label>
          </div>
